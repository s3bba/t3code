...
const isValidSemver = (value: string) => Bun.semver.satisfies(value, "x.x.x");
...
for (const [slug, list] of Array.from(versions.entries())) {
...
function parseEntry(label: string): { name: string; version: string } | null {
