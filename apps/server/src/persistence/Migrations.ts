...
import Migration0017 from "./Migrations/017_ProjectionSchemaCompatibilityBackfill.ts";
...
const loader = Migrator.fromRecord({
  ...
  "16_ProjectionProjectsDevShell": Migration0016,
  "17_ProjectionSchemaCompatibilityBackfill": Migration0017,
});
